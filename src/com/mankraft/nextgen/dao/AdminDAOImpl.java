...
public class AdminDAOImpl implements AdminDAO {
	...
	public int saveAdmin(AdminForm adminForm) throws DataAccessException {
		...
		String sql = "insert into s_admin_register(firstName,lastName,email,password,gender,mobileNumber,dateofbirth,address,city,state)  values('"
	...
	public boolean validateAdminLogin(AdminForm adminForm) {
		...
		String sql = "SELECT count(*) from s_admin_register WHERE email = ? and password=?";
	...
	public String changePassword(ChangePassword changePassword) {
		...
		String sql = "update  s_admin_register SET password= '" + newPassword + "' , conformPassword='" + confirmPassword
		...
		String sql2 = "update  s_admin_register SET password= '" + newPassword + "' , conformPassword='" + confirmPassword + "', oldPassword= '" + newPassword + "' ";
		LOGGER.info(sql2);
		...
		if (rowcount == 1) {
			...
			String sql3 = "update s_admin_register SET oldPassword= '" + newPassword + "' where password='" + newPassword
					+ "'";
			LOGGER.info(sql3);
	...
	public String forgotPassword(ChangePassword changePassword) {
		...
		String sql = "update s_admin_register SET newPassword='" + changePassword.getNewPassword() + "' where userName='"+ changePassword.getUserName() + "'";
